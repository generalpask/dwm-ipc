...
static const char *termcmd[]  = { "xst", "-e", "/usr/bin/zsh", NULL };
static const char *roficmd[]  = { "rofi", "-show", "run", "-display-run", ">", "-font", "IBM Plex Mono Bold 12", "-theme", "~/.config/isaac.rasi", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,			        XK_y,		          setlayout,	    {.v = &layouts[3]} }, /* bstack */
	...
	{ MODKEY,		            XK_z,		          incrgaps,	        {.i = +8 } },
	{ MODKEY,		            XK_x,		          incrgaps,	        {.i = -8 } },
	...
	{ 0,                        XF86XK_AudioRaiseVolume,     spawn,             SHCMD("amixer -c 1 set Master 5%+") },
	{ 0,                        XF86XK_AudioLowerVolume,     spawn,             SHCMD("amixer -c 1 set Master 5%-") },
